...
def gen_fmla(prefix, param, seed, size, max_int, typ, scale, aps):
    ...
    print("../mdl2mdl fmlas/{}.mdl fmlas/{}.mdlaerial fmlas/{}.mfodl".format(name, name, name), file=bash)
...
def gen_exp(name):
    for i in exps[name]["range"]:
        ...
        print("../mdl2mdl fmlas/{}.mdl fmlas/{}.mdlaerial fmlas/{}.mfodl".format(file_name, file_name, file_name), file=bash)
